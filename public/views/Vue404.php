...
<head>
    <meta charset="utf-8" />
    <link rel="stylesheet" type="text/css" href="CSS/Css404.css">
    <link rel="stylesheet" type="text/css" href="CSS/CssHeader.css">
    <link href="https://fonts.googleapis.com/css?family=Raleway" rel="stylesheet">
    <title>Menu contrôle des lumières</title>
</head>
<?php include 'VueHeader.php';?>

<body>
    <div class="error-cat-container">
        <div class="error-cat-column">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 167"><defs><style>.a{fill:#84A5FF;opacity:0.15;}.b,.e{fill:#fff;}.b,.c,.e,.f{stroke:#84A5FF;}.b,.d,.f{stroke-linejoin:round;}.b,.c,.d,.e,.f{stroke-width:2px;}.c{fill:#B2C7FF;}.c,.e{stroke-miterlimit:10;}.d,.f{fill:none;stroke-linecap:round;}.d{stroke:#fff;}</style></defs><title>404-icon</title><ellipse class="a" cx="70" cy="162" rx="60" ry="5"/><polygon class="b" points="71.71 1 30.29 1 1 30.29 1 71.71 30.29 101 71.71 101 101 71.71 101 30.29 71.71 1"/><polygon class="c" points="69.64 6 32.36 6 6 32.36 6 69.64 32.36 96 69.64 96 96 69.64 96 32.36 69.64 6"/><polyline class="d" points="34.15 63.87 34.15 39.22 19.32 56.78 37.24 56.78"/><polyline class="d" points="77.23 63.87 77.23 39.22 62.4 56.78 80.32 56.78"/><ellipse class="d" cx="50.34" cy="51.55" rx="9.13" ry="12.32"/><rect class="e" x="46" y="101" width="10" height="60"/><rect class="a" x="46" y="101" width="10" height="6"/><polygon class="e" points="101 161 53 161 69 91 85 91 101 161"/><line class="f" x1="37" y1="161" x2="117" y2="161"/><polygon class="c" points="63.29 116 90.71 116 88.89 108 65.11 108 63.29 116"/><polygon class="c" points="59.17 134 94.83 134 93 126 61 126 59.17 134"/>
            </svg>
        </div>
        <div class="error-cat-column">
            <h1>Oups !</h1>
            <p>La page demandée n'existe pas ou a été supprimée : (</p>
            <a class="error-cat-button" href="VueHomepage.php">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 387.375 387.375" style="enable-background:new 0 0 387.375 387.375;" xml:space="preserve"><g>
                ...
                <path d="M88.504,305.035c-5.949-5.946-15.583-5.946-21.531,0c-5.949,5.94-5.949,15.584,0,21.531    c2.942,2.943,5.977,5.776,9.055,8.482c2.885,2.543,6.468,3.785,10.037,3.785c4.236,0,8.445-1.748,11.449-5.177    c5.547-6.317,4.922-15.938-1.398-21.492C93.528,309.891,90.986,307.512,88.504,305.035z" fill="#FFFFFF"/></g>
                </svg>
                <p>Revenir au menu principal</p>
            </a>
        </div>
    </div>
</body>
